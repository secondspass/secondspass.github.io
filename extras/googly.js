			...
			case 'WinSize':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							winWidth: _elm_lang$core$Basics$toFloat(_p1.width),
							winHeight: _elm_lang$core$Basics$toFloat(_p1.height)
						}),
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mouseX: _elm_lang$core$Basics$toFloat(_p2.x),
							mouseY: _elm_lang$core$Basics$toFloat(_p2.y)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Main$MouseCoords = function (a) {
	return {ctor: 'MouseCoords', _0: a};
};
var _user$project$Main$WinSize = function (a) {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$window$Window$resizes(_user$project$Main$WinSize),
			_1: {
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_user$project$Main$MouseCoords),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$getWindowSize = function (result) {
	var _p3 = result;
	if (_p3.ctor === 'Ok') {
		return _user$project$Main$WinSize(_p3._0);
	} else {
...
var _user$project$Main$init = {
	...
	_1: A2(_elm_lang$core$Task$attempt, _user$project$Main$getWindowSize, _elm_lang$window$Window$size)
};
